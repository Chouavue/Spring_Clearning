...
-- INSERT INTO `shirts_db`.`shirts` (`shirt_id`, `article`, `color`, `shirt_size`, `last_worn`) VALUES ('1', 't-shrit', 'white', 'S', '10');
...
-- INSERT INTO shirts_db.shirts (shirt_id, article, color, shirt_size, last_worn)
...
-- SELECT article, color, shirt_size, last_worn FROM shirts_db.shirts
-- WHERE shirt_size='M';

--Update all polo shirts Change their size to L
-- UPDATE shirts_db.shirts
-- SET shirt_size="L"
